...
const ProtectedRoute = ({ children, useDashboardLayout = false, allowedRoles }) => {
        ...
        <ErrorBoundary>
          ...
          <Routes>
            ...
            <Route path="/home" element={
              <ProtectedRoute allowedRoles={['student', 'teacher', 'advisor']}>
                <Home />
              </ProtectedRoute>
            } />
            ...
            <Route path="/dashboard" element={
              <ProtectedRoute useDashboardLayout={true} allowedRoles={['teacher']}>
                <Dashboard />
              </ProtectedRoute>
            } />
            <Route path="/student/dashboard" element={
              <ProtectedRoute useDashboardLayout={true} allowedRoles={['student']}>
                <StudentDashboard />
              </ProtectedRoute>
            } />
            ...
            <Route path="/lessons" element={
              <ProtectedRoute useDashboardLayout={true} allowedRoles={['teacher', 'advisor']}>
                <LessonsPage />
              </ProtectedRoute>
            } />
            ...
            <Route path="/advisor/dashboard" element={
              <ProtectedRoute useDashboardLayout={true} allowedRoles={['advisor']}>
                <AdvisorDashboard />
              </ProtectedRoute>
            } />
            ...
            <Route path="/advisor/students/:studentId/performance" element={
              <ProtectedRoute useDashboardLayout={true} allowedRoles={['advisor']}>
                <StudentPerformance />
              </ProtectedRoute>
            } />
            <Route path="/advisor/lessons" element={
              <ProtectedRoute useDashboardLayout={true} allowedRoles={['advisor']}>
                <AdvisorLessons />
              </ProtectedRoute>
            } />
